...
function renderUI() {
  ...
  if(employees.length == 0){
    ...
    <h2 style="text-align: center;">Add to car <a href="./form.html">click here.</a></h2>
    ...
    for (let i = 0; i < employees.length; i++) {
      ...
      <div class="grid__card__tittle">
        ...
        <div class="grid__card__tittle_card">
          ...
          <span>${employees[i].capasity} People</span>
        </div>
      </div>
...
function deleteCard(id) {
  ...
  employees.splice(checkCartIndex, 1);
  localStorage.setItem("employees", JSON.stringify(employees));
  renderUI();
}
